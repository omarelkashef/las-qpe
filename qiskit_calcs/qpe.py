...
mol = gto.M (atom = xyz, basis = 'sto-3g', output='h2_sto3g.log',
...
# 1-electron part of the Hamiltonian for fragments
...
# 2-electron part of the Hamiltonian for fragments
...
for frag in range(len(ncas_sub)):
    ...
    quantum_instance = QuantumInstance(backend = least_busy(small_devices), shots=args.shots)
